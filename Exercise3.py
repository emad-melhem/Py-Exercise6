...
print(f"all of the red and orange fruits but none of the other ones is {(fruits & red_objects) | (fruits & orange_objects)}")
print(f"all of the objects without the fruits is {(red_objects - fruits) | (orange_objects - fruits)}")
